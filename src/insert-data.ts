...
async function createEntries() {
    ...
    const insertUserText = 'INSERT INTO users (email, password) VALUES ($1, $2) RETURNING id'; // here $1 $2 are used to prevent the database from sql injection .
    const userValues = ['johnsumite@gmail2.com', 'hashed_password_here'];
